...
default_args = {
    ...
    'dir': '/usr/src/challenge/dbt_challenge',
    # 'queue': 'bash_queue',
    # 'pool': 'backfill',
    # 'priority_weight': 10,
    #'end_date': days_ago(0), # ensuring only one run in this case
    'schedule_interval': 'None', # could set to daily, and potentially edit start/end date
}
