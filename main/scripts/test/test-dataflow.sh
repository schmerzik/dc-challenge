...
python3 ./init-data.py --gsfile gs://challenge-import/sample_products*.csv \
	--bq-dataset source --table products_test_af --region europe-west1 \
...
python3 ./init-data.py --gsfile gs://challenge-import/sample_customers*.csv \
	--bq-dataset source --table customers_test_af --region europe-west1 \
	--temp_location gs://challenge-import/tmp --project nomadic-asset-268508 \
	--service_account_email challenge@nomadic-asset-268508.iam.gserviceaccount.com \
...
python3 ./init-data.py --gsfile gs://challenge-import/sample_orders*.csv \
	--bq-dataset source --table orders_test_af --region europe-west1 \
	--temp_location gs://challenge-import/tmp --project nomadic-asset-268508 \
	--service_account_email challenge@nomadic-asset-268508.iam.gserviceaccount.com \
